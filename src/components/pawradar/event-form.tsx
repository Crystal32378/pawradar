...
function CreatedPanel({
  ...
  return (
    <div className="rounded-3xl border border-success/40 bg-gradient-to-br from-success/5 to-accent/5 p-5 shadow-sm sm:p-7">
      <div className="flex items-center gap-2.5">
        <div className="flex h-9 w-9 items-center justify-center rounded-[0.7rem] bg-success text-success-foreground">
          <Check size={20} />
        </div>
        <div>
